...
function attachEvents(){
    ...
    for (var i = 0, len = themesItems.length; i < len; i++) {
        ...
        // dirty workaround for make slides link more obvious:
        let themeContent = themeItem.querySelector('ol');
        themeContent.addEventListener('mouseover', function () {
            themeContent.title = 'Click icon for presentation slides'
        })
    };
}
